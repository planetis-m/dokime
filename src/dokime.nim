...
template query*(): untyped {.varargs, plugin: "dokime/private/queryplugin".}
...
template queryOne*(): untyped {.varargs, plugin: "dokime/private/queryplugin".}
  ## Alias for `query`.

template queryOpt*(): untyped {.varargs, plugin: "dokime/private/queryplugin".}
...
template rows*(): untyped {.varargs, plugin: "dokime/private/queryplugin".}
